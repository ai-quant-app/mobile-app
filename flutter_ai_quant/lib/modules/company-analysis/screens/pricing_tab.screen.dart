...
class PricingTab extends StatefulWidget {
  ...
  List<List<String>> moneyColumnData = [
    ['Price', '76,000', '',''],
  ...
  final List<TwoSectionsCardModel> epsData = [
    ...
    TwoSectionsCardModel("Model price", "94,906", true),
  ];
  @override

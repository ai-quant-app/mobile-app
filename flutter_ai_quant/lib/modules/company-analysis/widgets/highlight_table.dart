...
class HighlightTable extends StatefulWidget {
  final String title;
  final String footerNote;
  final Color footerColor;
  final List<String> columnHeaders;
  final List<List<Map<dynamic, dynamic>>> data;
  ...
  @override
  _HighlightTableState createState() => _HighlightTableState();
}

class _HighlightTableState extends State<HighlightTable> {

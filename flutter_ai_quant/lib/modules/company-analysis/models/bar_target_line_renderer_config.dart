...
import 'package:flutter_ai_quant/modules/company-analysis/models/bar_target_line_renderer.dart';
/// Configuration for a bar target line renderer.
class BarTargetTriangleRendererConfig<D> extends commonCharts.BaseBarRendererConfig<D> {
  ...
  BarTargetTriangleRendererConfig(
      {String customRendererId,
      List<int> dashPattern,
      groupingType = commonCharts.BarGroupingType.grouped,
      int layoutPaintOrder = commonCharts.LayoutViewPaintOrder.barTargetLine,
      int minBarLengthPx = 0,
      this.overDrawOuterPx,
      this.overDrawPx = 0,
      this.roundEndCaps = true,
      double strokeWidthPx = 3.0,
      commonCharts.SymbolRenderer symbolRenderer,
  ...
  @override
  BarTargetTriangleRenderer<D> build() {
    return BarTargetTriangleRenderer<D>(config: this, rendererId: customRendererId);
  }
  ...
  bool operator ==(other) {
    ...
    if (!(other is BarTargetTriangleRenderer)) {
      return false;
    }
